...
const t: Record<string, Record<string, string>> = {
  pt: {
    ...
    subtitle: "Assistente Virtual (24h) & Canais Diretos",
    placeholder: "Digite sua dúvida aqui...",
    level2Header: "Atendimento Humano - Suporte.ágiotech",
    whatsappTitle: "Suporte.ágiotech",
    whatsappNumber: "+55 22 99704-3245",
    emailTitle: "Email de Suporte",
    emailAddress: "suporte.agiotech@gmail.com",
    whatsapp: "WhatsApp (+55 22 99704-3245)",
    email: "suporte.agiotech@gmail.com",
    level2Trigger: "Falar com um Atendente / Ver Canais de Contato (Nível 2)",
    errorConnection: "Desculpe, ocorreu um erro ao se conectar com a nossa inteligência. Por favor, entre em contato direto pelo WhatsApp +55 22 99704-3245 (Suporte.ágiotech) ou e-mail suporte.agiotech@gmail.com.",
    errorGeneral: "Desculpe, ocorreu um erro."
  },
  en: {
    title: "Help & Support Center",
    subtitle: "Virtual Assistant (24h) & Direct Channels",
    placeholder: "Type your question here...",
    level2Header: "Human Support - Suporte.ágiotech",
    whatsappTitle: "Suporte.ágiotech",
    whatsappNumber: "+55 22 99704-3245",
    ...
    whatsapp: "WhatsApp (+55 22 99704-3245)",
    email: "suporte.agiotech@gmail.com",
    level2Trigger: "Talk to an Agent / View Contact Channels (Level 2)",
    errorConnection: "Sorry, an error occurred. Please contact us directly via WhatsApp +55 22 99704-3245 (Suporte.ágiotech) or e-mail suporte.agiotech@gmail.com.",
    errorGeneral: "Sorry, an error occurred."
  },
  es: {
    title: "Centro de Ayuda y Soporte",
    subtitle: "Asistente Virtual (24h) y Canales Directos",
    placeholder: "Escribe tu duda aquí...",
    level2Header: "Atención Humana - Suporte.ágiotech",
    whatsappTitle: "Suporte.ágiotech",
    whatsappNumber: "+55 22 99704-3245",
    emailTitle: "E-mail de Soporte",
    emailAddress: "suporte.agiotech@gmail.com",
    whatsapp: "WhatsApp (+55 22 99704-3245)",
    email: "suporte.agiotech@gmail.com",
    level2Trigger: "Hablar con un Agente / Ver Canales de Contacto (Nivel 2)",
    errorConnection: "Lo sentimos, ocurrió un error. Por favor, póngase en contacto directamente vía WhatsApp +55 22 99704-3245 (Suporte.ágiotech) o correo electrónico suporte.agiotech@gmail.com.",
    errorGeneral: "Lo sentimos, ocurrió un error."
  }
};

const whatsappTexts: Record<string, string> = {
  pt: `Olá, Suporte.ágiotech!\nMeu nome é {userName} e gostaria de tratar sobre o seguinte tema:\n`,
  en: `Hello, Suporte.ágiotech!\nMy name is {userName} and I would like to talk about the following topic:\n`,
  es: `¡Hola, Suporte.ágiotech!\nMi nombre es {userName} y me gustaría tratar sobre el siguiente tema:\n`
};

const emailSubjects: Record<string, string> = {
  pt: `Suporte.ágiotech - Atendimento: [INFORME O TEMA DA SUA SOLICITAÇÃO]`,
  en: `Suporte.ágiotech - Support: [ENTER THE TOPIC OF YOUR REQUEST]`,
  es: `Suporte.ágiotech - Soporte: [INDIQUE EL TEMA DE SU SOLICITUD]`
};

const emailBodies: Record<string, string> = {
  pt: `Olá, Equipe Suporte.ágiotech!\n\nMeu nome é {userName}.\n\nPor favor, descreva detalhadamente abaixo o erro encontrado ou sua solicitação:\n- [DESCREVA SEU PROBLEMA OU SUGESTÃO AQUI]\n\nObrigado!`,
  en: `Hello, Suporte.ágiotech Team!\n\nMy name is {userName}.\n\nPlease describe in detail below your question or issue:\n- [DESCRIBE YOUR PROBLEM OR SUGGESTION HERE]\n\nThank you!`,
  es: `¡Hola, Equipo de Suporte.ágiotech!\n\nMi nombre es {userName}.\n\nPor favor, describa a continuación su problema o duda:\n- [DESCRIBA SU PROBLEMA AQUÍ]\n\n¡Gracias!`
};
      ...
      <div className="bg-[#06402B] text-white w-full max-w-lg rounded-2xl shadow-2xl flex flex-col h-[85vh] max-h-[700px] animate-in fade-in zoom-in-95 duration-200 border border-white/20 relative overflow-hidden">
        <div className="p-4 border-b border-white/10 flex justify-between items-center bg-[#042118] rounded-t-2xl shrink-0">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="text-xs bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-300 border border-emerald-500/40 px-2.5 py-1.5 rounded-lg flex items-center gap-1.5 transition-colors cursor-pointer font-medium"
            >
              <span className="material-symbols-outlined text-[16px] shrink-0 notranslate" translate="no">contact_support</span>
        ...
        {showLevel2 && (
          <div className="px-4 py-3 bg-[#042118] border-t border-white/10 shrink-0">
            <p className="text-xs font-bold text-center text-white/90 mb-3 border-b border-white/10 pb-2">{texts.level2Header}</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              <a 
                href={`https://wa.me/5522997043245?text=${whatsappText}`} 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center gap-3 bg-[#25d366]/20 hover:bg-[#25d366]/30 border border-[#25d366]/40 text-white p-3 rounded-xl transition-all cursor-pointer group shadow-sm"
              >
                <div className="w-9 h-9 rounded-lg bg-[#25d366]/30 flex items-center justify-center text-[#25d366] shrink-0 group-hover:scale-105 transition-transform">
                  <span className="material-symbols-outlined text-[20px] shrink-0 notranslate" translate="no">chat</span>
                </div>
                <div className="flex flex-col min-w-0 text-left">
                  <span className="text-xs font-bold text-white truncate">Suporte.ágiotech</span>
                  <span className="text-[11px] text-[#25d366] font-semibold tracking-wide">+55 22 99704-3245</span>
                </div>
              </a>

              <a 
                href={`mailto:suporte.agiotech@gmail.com?subject=${emailSubject}&body=${emailBody}`} 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center gap-3 bg-emerald-500/20 hover:bg-emerald-500/30 border border-emerald-500/40 text-white p-3 rounded-xl transition-all cursor-pointer group shadow-sm"
              >
                <div className="w-9 h-9 rounded-lg bg-emerald-500/30 flex items-center justify-center text-emerald-300 shrink-0 group-hover:scale-105 transition-transform">
                  <span className="material-symbols-outlined text-[20px] shrink-0 notranslate" translate="no">mail</span>
                </div>
                <div className="flex flex-col min-w-0 text-left">
                  <span className="text-xs font-bold text-white truncate">{texts.emailTitle}</span>
                  <span className="text-[11px] text-emerald-300 font-semibold truncate">suporte.agiotech@gmail.com</span>
                </div>
              </a>
            </div>
          </div>
